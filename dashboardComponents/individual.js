    ...
    <div className="container-fluid d-flex">
      <div className="d-flex flex-column w-50">
        ...
        <div className="d-flex m-3 flex-column">
          <div className="h3 mb-4">STUDENT NAME OR PARTICIPANT ID HOUSE</div>
          <br />
          <br />
      ...
      <div className="graph-container p-3 mx-3">
        <div className="apache-graph-holder card border border-danger border-2">
          apache graph display
        </div>
      </div>
    </div>
  );
